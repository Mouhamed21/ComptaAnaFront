...
//import { ImportationComponent } from './components/Journal/importation/importation.component';
...
@NgModule({
    ...
    declarations: [
        ...
        Addcompte2Component,
        CGJournalComponent,
        ParametrageNiveauComponent,
        //ImportationComponent,
    ],
    providers: [
        {provide: LocationStrategy, useClass: HashLocationStrategy},
        CountryService, CustomerService, EventService, IconService, NodeService,
        PhotoService, ProductService, ProductService2, MenuService, ConfigService, MessageService, ConfirmationService, CompteService
    ],
