    ...
    ngOnInit() {
        this.model = [
            ...
            },
            {
                ...
                items:[
                    {label: 'Comptes Postal',icon: 'pi pi-fw pi-user-edit', routerLink: ['/CP_Compte']},
                    {label: 'Comptes General',icon: 'pi pi-fw pi-user-edit', routerLink: ['/CG_Compte']},
                    {label: 'Comptes Analytique',icon: 'pi pi-fw pi-user-edit', routerLink: ['/CA_Compte']}
                ]
            },
            {
                label: 'Journal',
                items:[
                    {label: 'CG Journal',icon: 'pi pi-fw pi-user-edit', routerLink: ['/CG_Journal']}
                ]
            },
            {
                label: 'Parametrage',
                items:[
                    {label: 'Parametrage Niveau',icon: 'pi pi-fw pi-check-square', routerLink: ['/Parametrage_Niveau']}
                ]
            },
            {
                label: 'UI Components',
